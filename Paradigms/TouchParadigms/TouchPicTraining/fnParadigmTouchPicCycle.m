function [strctOutput] = fnParadigmTouchPicCycle(strctInputs)
%
...
function fFlipTime = fnDrawTwoSpotsOnStimulusScreen(pt2iSpot_A, pt2iSpot_B, ...
  fSpotSizePix, aiColor_A, aiColor_B)
    global g_strctStimulusServer
