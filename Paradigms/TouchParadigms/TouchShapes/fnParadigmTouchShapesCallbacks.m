function fnParadigmTouchShapesCallbacks(strCallback,varargin)
%
...
switch strCallback
    ...
    case 'ToggleRandomOrder'
        g_strctParadigm.m_bToggleRandomOrder = ~g_strctParadigm.m_bToggleRandomOrder;
        set(g_strctParadigm.m_strctControllers.m_hRandomOrder,'value',g_strctParadigm.m_bToggleRandomOrder);
    ...
    otherwise
        fnParadigmToKofikoComm('DisplayMessage', [strCallback,' not handled']);
